    ...
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <form action="{{route('login')}}" method="post">
                @csrf
                <p class="auth-description">Por favor, inicie sesion para ingresar al panel de administrador<br>¿No tiene una cuenta? <a href="{{route('register')}}">Registrarse</a></p>

                <div class="auth-credentials m-b-xxl">
                    <label for="signInEmail" class="form-label">Dirección de correo electrónico</label>
                    <input name="email" type="email" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail" placeholder="example@gmail.com">
